class AlbumWithImageSerializer
  ...
  attributes :id, :name, :run_time, :release_year, :label, :image, :image_url, :artist, :genre, :instock_products, :instock_cds, :instock_vinyl, :instock_cassettes, :products, :cds, :vinyl, :cassettes, :songs
